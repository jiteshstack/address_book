import 'package:address_book/utils/constants.dart';
...
class _SearchListState extends State<SearchList> {
  ...
  void init() {
    _list = contacts.map((e) => e[Strings.name].toString()).toList();
  }
            ...
            if (this.actionIcon.icon == Icons.search) {
              ...
              this.appBarTitle = TextField(
                ...
                decoration: InputDecoration(
                    ...
                    hintText: Strings.searchContact,
